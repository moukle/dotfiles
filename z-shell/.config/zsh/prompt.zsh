...
# [ "${+MNML_RPROMPT}" -eq 0 ] && MNML_RPROMPT=('mnml_cwd 2 0')
...
# 	local a_files="$(command ls -1A | sed -n '$=')"
...
# 		COLUMNS=$COLUMNS CLICOLOR_FORCE=1 command ls -C -G -F
# 	else
# 		command ls -C -F --color="always" -w $COLUMNS
# 	fi
# }
