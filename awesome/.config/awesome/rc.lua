...
user = {
    ...
    dirs = {
        ...
        music = os.getenv("XDG_MUSIC_DIR") or "~/Media/Music/",
        pictures = os.getenv("XDG_PICTURES_DIR") or "~/Media/Images/",
        videos = os.getenv("XDG_VIDEOS_DIR") or "~/Media/Videos/",
        -- Make sure the directory exists so that your screenshots
        -- are not lost
        screenshots = os.getenv("XDG_SCREENSHOTS_DIR") or "~/Media/Scrots/",
    },
    ...
    openweathermap_key = "acadd8b7d5f267dd3440fa13d639c459",
    openweathermap_city_id = "2950978",
...
awful.rules.rules = {
    ...
    -- Game clients/launchers
    {
        ...
        properties = { tag = screen.primary.tags[8] }
    },
    ...
    -- All clients that I want out of my way when they are running
    {
        ...
        properties = { tag = screen.primary.tags[10] }
    },
